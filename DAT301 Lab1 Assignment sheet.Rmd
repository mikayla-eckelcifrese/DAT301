...
```{r message=TRUE, warning=TRUE, paged.print=FALSE}
    ...
    RainfallBarGraph = barplot(RainfallByLocation, main = "Total 2016 Rainfall by Location",                                             xlab = "Location", ylab = "Rainfall(mm)", 
                               ylim = c(0, 1500),col = "deeppink")
    text(x = RainfallBarGraph, y = counts + 90, labels = as.character(counts), cex = 1.0, col = "purple")
